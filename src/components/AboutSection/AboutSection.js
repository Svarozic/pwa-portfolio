                ...
                <div className="row">
                    ...
                    <div className="col s12 m8 left-align">
                        <p className="pp-description">
                            Hello, my name is <b>Ing. Peter Petraník</b> and I am 25 years old developer with current location in
                            Bratislava.
                        ...
                        <a className="waves-effect waves-light btn-large"
                           ...
                           rel="noopener noreferrer" target="_blank"><i className="fa fa-cloud-download left"/>Download CV</a>
                    </div>
